...
export default class ROSInterface {
    ...
    /*******************************************************************
     * createService Function, to create a ROS Service Server.
    ...
    /***************************************************************************
     * callService Function, to call a ROS Service.
     * @param {*} service_name , String, the name of the service, e.g.
     * '/add_two_ints' 
     * @param {*} service_type , String, the type of the service,
     * e.g.'rospy_tutorials/AddTwoInts' 
    ...
    callService(service_name, service_type, params) {
        ...
        const request = new ROSLIB.ServiceRequest(params);
